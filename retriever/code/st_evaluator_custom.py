...
from retriever_evaluation_custom import evaluate_retriever_on_dataset, evaluate_retriever_on_dataset_with_ett_score
...
class RetrievalEvaluator(SentenceEvaluator):
    ...
    def __init__(self, TRAIN_FN, index_set, DEV_FN, name: str = '', batch_size: int = 32, show_progress_bar: bool = False, write_csv: bool = True):
        ...
        self.csv_headers = ["epoch", "steps",
                            "turnsv_score", "turns_score","allsv_score", "alls_score", "turnett_score", "turnsysett_score", "turnusrett_score"]
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        # slot accuracy only
        # main_score = scores['turns']['score']

        # # add turn_ett
        # main_score = scores['turnsv']['score'] + scores['turns']['score'] + scores['turnett']['score']
    ...
    def compute_metrices(self, model):
        ...
        turn_sv, turn_s, dial_sv, dial_s, turn_ett, turn_sysett, turn_usrett = evaluate_retriever_on_dataset_with_ett_score(test_set_21,retriever)

        output_scores = {'turnsv': {"score": turn_sv}, "turns": {"score": turn_s}, 
                            "allsv": {"score": dial_sv}, "alls": {"score": dial_s}, 'turnett':{"score": turn_ett}, 'turnsysett':{"score": turn_sysett}, 'turnusrett':{"score": turn_usrett}}
